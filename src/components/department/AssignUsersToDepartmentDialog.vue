  ...
  >
    <div class="assign-users-container">
      ...
      >
        ...
        <el-table-column prop="departmentName" label="当前部门" width="140" />
...
const handleAssignUsers = async () => {
  ...
  try {
    ...
    // 调用API将用户分配到部门
    const res = await departmentApi.assignUsersToDepartment(props.department.id, { userIds })
